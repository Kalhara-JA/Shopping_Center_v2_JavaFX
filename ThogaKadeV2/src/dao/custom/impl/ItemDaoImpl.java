...
public class ItemDaoImpl implements ItemDao {
    ...
    public boolean save(Item i) throws SQLException, ClassNotFoundException {
        return CrudUtil.execute("INSERT INTO Item values (?,?,?,?)",i.getDescription(),i.getDescription(),i.getUnitPrice(),i.getQtyOnHand());
    }
    ...
    public boolean update(Item i) throws SQLException, ClassNotFoundException {
        return CrudUtil.execute("UPDATE Item SET description=?, unitPrice=?, qtyOnHand=? WHERE code=?",i.getDescription(),i.getUnitPrice(),i.getQtyOnHand(),i.getCode());
